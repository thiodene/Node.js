...
function main()
{
  ...
  //var n = 6;
  //var oldEdges = [[1,4],[4,5],[2,3]];
  //var newEdges = [[1,2,5],[1,3,10],[1,6,2],[5,6,5]];

  var oldCost = 0;
  // Add the old edges to new edges
  oldEdges.forEach(function(element){
    newEdges.push([element[0],element[1],1]);
    oldCost++;
  });
...
//  return false;
  ...
  {
    // If the number of Edges equals the number of nodes - 1 => we have an MST
    // Caculate directly the MST
